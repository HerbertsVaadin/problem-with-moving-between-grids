package com.example.application.views.workaround;
...
@Route(value = "workaround", layout = MainView.class)
@PageTitle("Workaround")
public class WorkaroundView extends VerticalLayout {
